...
extension SettingsQuerySortBy on QueryBuilder<Settings, Settings, QSortBy> {
  QueryBuilder<Settings, Settings, QAfterSortBy> sortByFirstLaunchDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstLaunchDate', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> sortByFirstLaunchDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsQuerySortThenBy
  ...
  QueryBuilder<Settings, Settings, QAfterSortBy> thenByFirstLaunchDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstLaunchDate', Sort.asc);
    });
  }

  QueryBuilder<Settings, Settings, QAfterSortBy> thenByFirstLaunchDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'firstLaunchDate', Sort.desc);
    });
  }
...
extension SettingsQueryWhereDistinct
  ...
  QueryBuilder<Settings, Settings, QDistinct> distinctByFirstLaunchDate() {
    return QueryBuilder.apply(this, (query) {
